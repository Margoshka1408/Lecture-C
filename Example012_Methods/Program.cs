...
// Вид 2
void Method2(string msg)//ничего не возвращают
{
...
void Method21(string msg,int count)
{
    ...
    {
        Console.WriteLine(msg);
        i++;//если счетчик увеличивается-инкремент, уменьшается-декремент
    }
}
...
{
    string result=String.Empty;//присвоение пустой строки
